...
**和 AI 一起理清复杂内容，逐步写成一份完整、成熟的长文档。**

A collaborative writing skill for developing ideas and source material into clear, complete long-form documents.
...
**Sentence Gate 是用具体句子校准事实与意思的讨论点。** 例如，作者说“还没有全部跑通”，Agent 应更新对项目完成状态的理解，并调整后续路线、成果和总结，而不只是换掉“完整链路”四个字。它不要求每次只能写一句。 核心定义、关键结论、方法边界和有争议的事实需要检查。依据与修改授权明确时，Agent 可以继续；只有关键事实、作者意思或已确认决策存在未解决冲突时，才需要讨论。你也可以明确要求逐句确认或直接产出完整草稿。
